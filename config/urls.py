...
try:
    ...
    Exception
):  # pragma: no cover - fallback for environments where locale app is disabled
...
urlpatterns = [
    ...
    path(
        "eğitim/", include(("education.urls", "education"), namespace="education_tr")
    ),  # Turkish alias
    ...
    path(
        "game-app/",
        include(("games.game_app.urls", "game_app"), namespace="game_app_en"),
    ),  # English alias for game_app
    path(
        "oyun-uygulaması/",
        include(("games.game_app.urls", "game_app"), namespace="game_app_tr"),
    ),  # Turkish alias for game_app
    path(
        "integrations/gib/",
        include(("integrator_gib.urls", "integrator_gib"), namespace="integrator_gib"),
    ),
    path(
        "integrations/mock/",
        include(
            ("integrator_mock.urls", "integrator_mock"), namespace="integrator_mock"
        ),
    ),
    path(
        "kobi-analysis/",
        include(("kobi_analysis.urls", "kobi_analysis"), namespace="kobi_analysis"),
    ),
    path(
        "management/",
    ...
    path(
        "developers/",
        include(
            ("developer_portal.urls", "developer_portal"), namespace="developer_portal"
        ),
    ),
    path("partners/", include(("partners.urls", "partners"), namespace="partners")),
    path(
        "permissions/",
        include(("permissions.urls", "permissions"), namespace="permissions"),
    ),
    ...
    path(
        "virtual-company/",
        include(
            ("virtual_company.urls", "virtual_company"), namespace="virtual_company"
        ),
    ),
    path(
        "api/dashboard/",
        include(("api.urls_dashboard", "api_dashboard"), namespace="api_dashboard"),
    ),
...
MARKETING_ROUTES = [
    ...
    (
        "training/finance-dashboard/",
        "training_finance_dashboard",
        "training_finance_dashboard",
    ),
    (
        "training/compliance-engine/",
        "training_compliance_engine",
        "training_compliance_engine",
    ),
    (
        "training/gamification-students/",
...
urlpatterns += [
    ...
    path(
        "resources/training/",
        core_ui_views.resource_training,
        name="resources_training",
    ),
    path(
        "resources/academy/", core_ui_views.resource_academy, name="resources_academy"
    ),
    path(
        "resources/developer-hub/",
        core_ui_views.resource_developer_hub,
        name="resources_developer_hub",
    ),
    path(
        "resources/partner-marketplace/",
        core_ui_views.resource_partner_marketplace,
        name="resources_partner_marketplace",
    ),
]
...
urlpatterns += [
    path(
        ...
        RedirectView.as_view(
            url=settings.STATIC_URL + "common/favicon.ico", permanent=True
        ),
        name="favicon",
    ),
]
