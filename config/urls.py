...
urlpatterns = [
    ...
    path('game-app/', include(('games.game_app.urls', 'game_app'), namespace='game_app_en')),  # English alias for game_app
    path('oyun-uygulaması/', include(('games.game_app.urls', 'game_app'), namespace='game_app_tr')),  # Turkish alias for game_app
