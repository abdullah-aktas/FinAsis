...
class AuditBlockchain:
    ...
    def is_chain_valid(self) -> Tuple[bool, Optional[str]]:
        ...
        for i in range(1, len(self.chain)):
            ...
            if current_block.previous_hash != previous_block.hash:
                return False, f"Blok {i} zincir bağlantısı kopuk! Önceki hash uyuşmuyor."
    ...
    def get_blocks_by_date_range(self, start_date: datetime, end_date: datetime) -> List[AuditBlock]:
...
class BlockchainAuditManager:
    ...
    def add_audit_event_to_chain(self, audit_event) -> AuditBlock:
        ...
        event_data = {
            ...
            'financial_impact': float(audit_event.financial_impact) if audit_event.financial_impact else None,
        }
    ...
    def generate_audit_certificate(self, company_name: str, start_date: datetime, end_date: datetime) -> Dict:
        """
