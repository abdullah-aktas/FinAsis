...
def evaluate_formula(formula: str, ctx: Dict[str, Any]) -> Decimal:
    ...
    allowed = {
        ...
        "gross": Decimal(str(ctx.get("net_amount", 0)))
        * (Decimal("1") + Decimal(str(ctx.get("tax_rate", 0)))),
    }
