...
Hızlı Başlangıç (TDHP):
-----------------------
- Varsayılan TDHP hesap planını yüklemek için:
    python manage.py load_tdhp --company-id <ID>

- TDHP kod formatı doğrulamasını zorlamak için ayar ekleyin:
