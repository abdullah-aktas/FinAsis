...
try:
    from core.models import BaseModel, AuditableMixin  # type: ignore
except Exception:
    from finance.models import BaseModel
...
from finance.accounting.models import Voucher
from finance.models import Account
from finance.accounting.models import Currency
from finance.banking.models import BankAccount
from accounting.models import Customer
from accounting.models import Company as Supplier  # geçici eşleştirme
...
class Check(BaseModel, AuditableMixin):
    ...
    is_incoming = models.BooleanField(
        _("Alınan Çek"),
        default=True,
        help_text=_("Alınan çek için True, verilen çek için False"),
    )
    ...
    account_number = models.CharField(
        _("Hesap Numarası"), max_length=50, blank=True, null=True
    )
    ...
    endorsement_to = models.CharField(
        _("Ciro Edilen"), max_length=100, blank=True, null=True
    )
...
class Bill(BaseModel, AuditableMixin):
    ...
    is_incoming = models.BooleanField(
        _("Alınan Senet"),
        default=True,
        help_text=_("Alınan senet için True, verilen senet için False"),
    )
