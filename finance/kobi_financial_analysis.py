...
class KOBIFinancialAnalysis(models.Model):
    ...
    total_assets = models.DecimalField(_('Toplam Aktif'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_liabilities = models.DecimalField(_('Toplam Borç'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_equity = models.DecimalField(_('Toplam Özkaynak'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_revenue = models.DecimalField(_('Toplam Gelir'), max_digits=15, decimal_places=2, default=Decimal('0'))
    net_income = models.DecimalField(_('Net Kar'), max_digits=15, decimal_places=2, default=Decimal('0'))
...
class BudgetPlan(models.Model):
    ...
    total_budgeted_amount = models.DecimalField(_('Toplam Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_actual_amount = models.DecimalField(_('Toplam Gerçekleşen'), max_digits=15, decimal_places=2, default=Decimal('0'))
    variance_amount = models.DecimalField(_('Sapma Tutarı'), max_digits=15, decimal_places=2, default=Decimal('0'))
    variance_percentage = models.DecimalField(_('Sapma Yüzdesi'), max_digits=8, decimal_places=4, default=Decimal('0'))
...
class BudgetLine(models.Model):
    ...
    actual_amount = models.DecimalField(_('Gerçekleşen Tutar'), max_digits=15, decimal_places=2, default=Decimal('0'))
    variance_amount = models.DecimalField(_('Sapma Tutarı'), max_digits=15, decimal_places=2, default=Decimal('0'))
    variance_percentage = models.DecimalField(_('Sapma %'), max_digits=8, decimal_places=4, default=Decimal('0'))
    
    # Aylık detay (12 aylık dağılım için)
    january_budget = models.DecimalField(_('Ocak Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    february_budget = models.DecimalField(_('Şubat Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    march_budget = models.DecimalField(_('Mart Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    april_budget = models.DecimalField(_('Nisan Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    may_budget = models.DecimalField(_('Mayıs Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    june_budget = models.DecimalField(_('Haziran Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    july_budget = models.DecimalField(_('Temmuz Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    august_budget = models.DecimalField(_('Ağustos Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    september_budget = models.DecimalField(_('Eylül Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    october_budget = models.DecimalField(_('Ekim Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    november_budget = models.DecimalField(_('Kasım Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
    december_budget = models.DecimalField(_('Aralık Bütçe'), max_digits=15, decimal_places=2, default=Decimal('0'))
...
class CashFlowForecast(models.Model):
    ...
    week_1_net_flow = models.DecimalField(_('1. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_2_net_flow = models.DecimalField(_('2. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_3_net_flow = models.DecimalField(_('3. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_4_net_flow = models.DecimalField(_('4. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_5_net_flow = models.DecimalField(_('5. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_6_net_flow = models.DecimalField(_('6. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_7_net_flow = models.DecimalField(_('7. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_8_net_flow = models.DecimalField(_('8. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_9_net_flow = models.DecimalField(_('9. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_10_net_flow = models.DecimalField(_('10. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_11_net_flow = models.DecimalField(_('11. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_12_net_flow = models.DecimalField(_('12. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    week_13_net_flow = models.DecimalField(_('13. Hafta Net Akış'), max_digits=15, decimal_places=2, default=Decimal('0'))
    
    opening_cash_balance = models.DecimalField(_('Açılış Nakit Bakiyesi'), max_digits=15, decimal_places=2)
    minimum_cash_required = models.DecimalField(_('Minimum Nakit Gereksinimi'), max_digits=15, decimal_places=2, default=Decimal('0'))
    ...
    def _generate_cash_flow_alerts(self):
        ...
        average_flow = (total_flow / Decimal(str(len(weekly_flows)))) if weekly_flows else Decimal('0')
        for week, flow in enumerate(weekly_flows, 1):
            if flow < (average_flow * Decimal('2')) and flow < Decimal('0'):  # %200'den fazla negatif sapma
                alerts.append({
                    'type': 'large_outflow',
                    'severity': 'high',
...
class ProfitabilityAnalysis(models.Model):
    ...
    # Genel totaller
    total_revenue = models.DecimalField(_('Toplam Gelir'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_direct_costs = models.DecimalField(_('Toplam Direkt Maliyetler'), max_digits=15, decimal_places=2, default=Decimal('0'))
    total_indirect_costs = models.DecimalField(_('Toplam Endirekt Maliyetler'), max_digits=15, decimal_places=2, default=Decimal('0'))
    gross_profit = models.DecimalField(_('Brüt Kar'), max_digits=15, decimal_places=2, default=Decimal('0'))
    net_profit = models.DecimalField(_('Net Kar'), max_digits=15, decimal_places=2, default=Decimal('0'))
    
    # Karlılık oranları
    gross_margin_percentage = models.DecimalField(_('Brüt Kar Marjı %'), max_digits=8, decimal_places=4, default=Decimal('0'))
    net_margin_percentage = models.DecimalField(_('Net Kar Marjı %'), max_digits=8, decimal_places=4, default=Decimal('0'))
...
class ProfitabilityLine(models.Model):
    ...
    quantity_sold = models.DecimalField(_('Satılan Miktar'), max_digits=15, decimal_places=3, default=Decimal('0'))
    ...
    indirect_costs = models.DecimalField(_('Endirekt Maliyetler'), max_digits=15, decimal_places=2, default=Decimal('0'))
