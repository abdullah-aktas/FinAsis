...
urlpatterns = [
    ...
    # AJAX endpoints
    path('ajax/account-balance/<int:account_id>/', views.ajax_account_balance, name='ajax_account_balance'),
    path('ajax/sync-transactions/<int:account_id>/', views.ajax_sync_transactions, name='ajax_sync_transactions'),
