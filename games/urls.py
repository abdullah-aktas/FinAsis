...
from .views_esport import (
    player_hub, tournaments_list, tournament_detail, tournament_register,
    quests_page, store_page, buy_item, rankings_page, match_history,
    profile_page, friends_page, teams_page
)
...
urlpatterns = [
    ...
    path('tournament/<int:tournament_id>/register/', tournament_register, name='tournament_register'),
    ...
    # Alt uygulamalar
    path('trade-sim/', include(('games.trade_sim.urls', 'trade_sim'), namespace='trade_sim')),
    path('finquest/', include(('games.finquest.urls', 'finquest'), namespace='finquest')),
    path('game_app/', include(('games.game_app.urls', 'game_app'), namespace='game_app')),
