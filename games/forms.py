...
class GameForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'description': forms.Textarea(attrs={'rows': 4, 'placeholder': 'Oyunla ilgili kısa açıklama giriniz...'}),
...
class TransactionForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'description': forms.Textarea(attrs={'rows': 3, 'placeholder': 'İşlem detaylarını yazınız...'}),
        }
