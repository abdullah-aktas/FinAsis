...
class AnalyticsSystem:
    ...
    def track_event(
        self, event_type: EventType, player_id: str, data: Dict, session_id: str
    ) -> AnalyticsEvent:
        """Olay izleme"""
    ...
    def track_performance(
        self, metric: PerformanceMetric, value: float, context: Dict = None
    ) -> PerformanceData:
    ...
    def log_error(
        self, error_type: str, message: str, stack_trace: str, context: Dict = None
    ) -> Dict:
        """Hata kaydı"""
        error = {
            "id": str(uuid.uuid4()),
    ...
    def clear_old_data(self, days: int = 30):
        ...
        self.performance_data = [
            data for data in self.performance_data if data.timestamp > cutoff_date
        ]

        self.error_logs = [
            error for error in self.error_logs if error["timestamp"] > cutoff_date
        ]
