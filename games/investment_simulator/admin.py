...
class AssetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Fiyat"), {"fields": ("base_price", "current_price", "price_history")}),
        (
            _("Risk ve Getiri"),
            {"fields": ("risk_level", "volatility", "expected_return")},
        ),
        (_("Piyasa"), {"fields": ("trend", "momentum", "market_cap", "volume_24h")}),
...
class PortfolioAdmin(admin.ModelAdmin):
    ...
    def profit_loss_percentage_display(self, obj):
        ...
        return format_html('<span style="color: {};">{:.2f}%</span>', color, percent)
...
class MarketEventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Etki"), {"fields": ("affected_assets", "price_impact_percentage")}),
        (_("Zamanlama"), {"fields": ("event_date", "expires_at", "is_active")}),
        (_("Meta"), {"fields": ("created_at",), "classes": ("collapse",)}),
    )
