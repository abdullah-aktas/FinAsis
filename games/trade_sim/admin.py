...
from .models import City, Character, Quest, CharacterQuest, Tournament, TournamentEntry, GameNotification, ChatMessage, QrReward, UserQrReward
...
class TournamentEntryAdmin(admin.ModelAdmin):
    list_display = ('tournament', 'character', 'score', 'rank', 'reward_claimed', 'joined_at')
...
class ChatMessageAdmin(admin.ModelAdmin):
    list_display = ('user', 'room', 'message', 'created_at', 'is_deleted', 'is_reported')
