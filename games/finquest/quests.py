        ...
        "tutorial": [
            {
                ...
                "completion_criteria": lambda: "marketi_ziyaret_etti"
                in game.game_state,
            },
            {
                "id": "bank_visit",
                ...
                "completion_criteria": lambda: "bankayi_ziyaret_etti"
                in game.game_state,
            },
        ],
        "trading": [
        ...
        "accounting": [
            {
                ...
                "completion_criteria": lambda: "gelir_tablosu_olusturuldu"
                in game.game_state,
            },
            {
                "id": "balance_sheet",
        ...
        quests["special"] = [
            {
                ...
                "reward": {"money": 100, "exp": 10},
                "completion_criteria": lambda: game.game_state["player"]["money"]
                >= 1000,
            }
        ]
    elif age_group == "teen":
        quests["special"] = [
            {
                ...
                "reward": {"money": 200, "exp": 20},
                "completion_criteria": lambda: "butce_plani_olusturuldu"
                in game.game_state,
            }
        ]
        ...
        quests["special"] = [
            {
                ...
                "completion_criteria": lambda: "emeklilik_plani_olusturuldu"
                in game.game_state,
            }
        ]
