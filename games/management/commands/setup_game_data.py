...
from games.models import (
    Game, Season, Badge, DailyQuest, Item
)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with transaction.atomic():
            ...
            # 3. Rozetler oluştur
            badges_data = [
                {'name': 'Yeni Baslayan', 'icon': '🌟', 'rarity': 'common', 'points': 10, 'xp_reward': 50, 
                 'description': 'Ilk oyununuzu tamamlayin', 'criteria': {'games_played': 1}},
                {'name': 'Kazanan', 'icon': '🏆', 'rarity': 'common', 'points': 25, 'xp_reward': 100,
                 'description': 'Ilk zaferiniz', 'criteria': {'games_won': 1}},
                {'name': 'Ticaret Ustasi', 'icon': '💰', 'rarity': 'rare', 'points': 100, 'xp_reward': 500,
                 'description': 'TradeSim\'de 10 oyun kazanin', 'criteria': {'tradesim_wins': 10}},
                {'name': 'Borsa Asamasi', 'icon': '📈', 'rarity': 'rare', 'points': 150, 'xp_reward': 750,
                 'description': 'Borsa simülasyonunda 100k kar yapin', 'criteria': {'stock_profit': 100000}},
                {'name': 'Quiz Dehasi', 'icon': '🧠', 'rarity': 'epic', 'points': 200, 'xp_reward': 1000,
                 'description': 'Finans Quiz\'de mukemmel puan', 'criteria': {'quiz_perfect': 1}},
                {'name': 'Haftalik Kahraman', 'icon': '⭐', 'rarity': 'epic', 'points': 250, 'xp_reward': 1500,
                 'description': '7 gun ust uste oynatin', 'criteria': {'daily_streak': 7}},
                {'name': 'Efsane Oyuncu', 'icon': '👑', 'rarity': 'legendary', 'points': 1000, 'xp_reward': 5000,
                 'description': 'Challenger rankina ulasin', 'criteria': {'rank': 'challenger'}},
            ]
