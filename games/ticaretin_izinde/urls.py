...
from . import views
from .views import (
    UrsinaPlayerViewSet, PlayerWalletViewSet, UrsinaGameSessionViewSet,
    TournamentViewSet, AchievementViewSet, PlayerAchievementViewSet
)
...
router.register(r'players', UrsinaPlayerViewSet)
router.register(r'wallets', PlayerWalletViewSet)
router.register(r'sessions', UrsinaGameSessionViewSet)
router.register(r'tournaments', TournamentViewSet)
router.register(r'achievement-items', AchievementViewSet)
router.register(r'player-achievements', PlayerAchievementViewSet)
