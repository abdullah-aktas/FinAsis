...
try:
    from games.game_engine import GameEngine  # type: ignore
except Exception:  # pragma: no cover
    GameEngine = None
...
@pytest.mark.skipif(
    pygame is None or GameEngine is None, reason="pygame/engine not available"
)
class TestCloudSave(unittest.TestCase):
    ...
    def test_save_game_state(self):
        ...
        # Bildirim oluştur (gerçek entegrasyon)
        self.notification_system.send_notification(
            player_id,
            notification_type="cloud_save",
            title="Oyun Kaydedildi",
            message="Oyun durumunuz buluta kaydedildi",
        )
    ...
    def test_save_encryption(self):
        ...
        test_data = {"score": 1000, "inventory": ["item1", "item2"]}
