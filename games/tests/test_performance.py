...
class TestPerformance(unittest.TestCase):
    ...
    @unittest.skipUnless(PYGAME_AVAILABLE, "pygame module not available")
    ...
    def test_memory_usage(self):
        ...
        self.assertLessEqual(
            memory_increase, 100, "Bellek kullanımı 100MB'dan fazla arttı"
        )
    ...
    def test_notification_performance(self):
        ...
        for _ in range(100):
            self.notification_system.send_notification(
                "test_player", "system", "Test", "Test mesajı"
            )
        ...
        self.assertLessEqual(
            notification_duration, 1.0, "100 bildirim 1 saniyeden uzun sürdü"
        )
