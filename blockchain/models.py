...
class Block(models.Model):
    ...
    mined_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='mined_blocks')
...
class Transaction(models.Model):
    ...
    reference_model = models.CharField(max_length=50, blank=True)  # invoice, payment, etc.
    ...
    def __str__(self):
        return f"TX {self.transaction_id[:8]}... - {self.get_transaction_type_display()}"
...
class SmartContract(models.Model):
    ...
    abi = models.JSONField(default=dict, blank=True, help_text="Application Binary Interface")
...
class DigitalAsset(models.Model):
    ...
    contract = models.ForeignKey(SmartContract, on_delete=models.SET_NULL, null=True, blank=True)
...
class AssetBalance(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='asset_balances')
...
class AuditLog(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='blockchain_audit_logs')
...
class ChainRecord(models.Model):
    ...
    transaction = models.ForeignKey(Transaction, on_delete=models.SET_NULL, null=True, blank=True, related_name='chain_records')
    verified_at = models.DateTimeField(null=True, blank=True)
    verified_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='verified_chain_records')
