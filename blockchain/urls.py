...
urlpatterns = [
    ...
    path('contracts/<str:contract_address>/', views.contract_detail, name='contract_detail'),
    path('contracts/deploy/', views.contract_deploy, name='contract_deploy'),
    path('contracts/<str:contract_address>/execute/', views.contract_execute, name='contract_execute'),
