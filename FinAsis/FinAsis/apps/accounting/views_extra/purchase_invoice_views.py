...
def purchase_invoice_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'accounting/purchase_invoice_list.html', {'invoices': invoices})
...
def purchase_invoice_detail(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/purchase_invoice_detail.html', {'invoice': invoice})
...
def purchase_invoice_update(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/purchase_invoice_form.html', {'form': form, 'invoice': invoice})
...
def purchase_invoice_delete(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    if request.method == 'POST':
        invoice.delete()
        return redirect('accounting:purchase_invoice_list')
    return render(request, 'accounting/purchase_invoice_confirm_delete.html', {'invoice': invoice})
