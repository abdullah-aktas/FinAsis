...
try:
    from FinAsis.apps.finance.bank_integration.models import IntegratedBankAccount as FinanceBankAccount  # type: ignore
except Exception:
    FinanceBankAccount = None  # opsiyonel entegrasyon
from FinAsis.apps.accounting.models import Company, Customer
try:
    from FinAsis.apps.company.models import FiscalYear  # type: ignore
except Exception:
...
class Account(models.Model):
    ...
    def get_balance(self, start_date=None, end_date=None):
        from FinAsis.apps.finance.accounting.models import VoucherLine
