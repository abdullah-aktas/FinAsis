...
# Base/Audit mixinleri için yerel fallback
try:
    from core.models import BaseModel, AuditableMixin  # type: ignore
except Exception:  # pragma: no cover - core yoksa yerel BaseModel kullan
...
from FinAsis.apps.finance.models import Account, Voucher
