...
try:
    ...
    from src.apps.finance.models import BaseModel
    class AuditableMixin(models.Model):
        class Meta:
            abstract = True
from src.apps.accounting.models import Company
from src.apps.finance.accounting.models import Voucher
from src.apps.finance.models import Account
from src.apps.finance.accounting.models import Currency
from src.apps.finance.banking.models import BankAccount
from src.apps.accounting.models import Customer
from src.apps.accounting.models import Company as Supplier  # geçici eşleştirme
