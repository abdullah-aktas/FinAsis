# -*- coding: utf-8 from src.apps.kobi_analysis.models import *
...
from src.apps.kobi_analysis.models import KOBIFinancialAnalysis, BudgetPlan  # wildcard kaldırıldı
from src.apps.accounting.models import Company
from src.apps.finance.enhanced_accounting_models import JournalEntry  # ledger entries

# BudgetItem modeli henüz tanımlı değilse bütçe detay karşılaştırmasını atlaya biliriz
try:  # noqa: SIM105
    from src.apps.kobi_analysis.models import BudgetItem  # type: ignore
