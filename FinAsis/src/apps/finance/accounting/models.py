...
try:  # opsiyonel banka entegrasyonu
    from src.apps.finance.bank_integration.models import IntegratedBankAccount as FinanceBankAccount  # type: ignore
except Exception:
...
try:
    from src.apps.company.models import FiscalYear  # type: ignore
except Exception:
...
class Account(models.Model):
    ...
    def get_balance(self, start_date=None, end_date=None):
        from src.apps.finance.accounting.models import VoucherLine
