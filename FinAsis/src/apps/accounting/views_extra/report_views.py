...
def muhtasar_report_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'accounting/muhtasar_report.html', {'df': df, 'period': period, 'company': company, 'companies': companies})
...
def babs_report_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'accounting/babs_report.html', {'df': df, 'period': period, 'company': company, 'companies': companies})
