...
web_patterns = [
    ...
    path('<int:pk>/', VirtualCompanyDetailView.as_view(), name='virtual_company_detail'),
    path('<int:pk>/update/', VirtualCompanyUpdateView.as_view(), name='virtual_company_update'),
    path('<int:pk>/delete/', VirtualCompanyDeleteView.as_view(), name='virtual_company_delete'),
