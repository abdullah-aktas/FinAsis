...
urlpatterns = [
    ...
    path('trade-sim/', include(('src.apps.games.trade_sim.urls', 'trade_sim'), namespace='trade_sim')),
    # Game App alt uygulaması
    path('game_app/', include(('src.apps.games.game_app.urls', 'game_app'), namespace='game_app')),
] 
