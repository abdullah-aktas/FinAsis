...
def scenario_update(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/scenario_form.html', {'form': form, 'scenario': scenario})
...
def scenario_delete(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    if request.method == 'POST':
        scenario.delete()
        return redirect('accounting:scenario_list')
    return render(request, 'accounting/scenario_confirm_delete.html', {'scenario': scenario})
