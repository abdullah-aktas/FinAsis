...
def banktransaction_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'accounting/banktransaction_list.html', {'banktransactions': banktransactions})
...
def banktransaction_detail(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/banktransaction_detail.html', {'banktransaction': banktransaction})
...
def banktransaction_update(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/banktransaction_form.html', {'form': form, 'banktransaction': banktransaction})
...
def banktransaction_delete(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    if request.method == 'POST':
        ...
        return redirect('accounting:banktransaction_list')
    return render(request, 'accounting/banktransaction_confirm_delete.html', {'banktransaction': banktransaction}) 