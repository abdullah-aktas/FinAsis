...
def export_report_to_json(report_data):
    """Verilen rapor verisini JSON olarak dışa aktarır (şablon)."""
    # TODO: JSON dışa aktarım
    pass

def export_report_to_xml(report_data):
    """Verilen rapor verisini XML olarak dışa aktarır (şablon)."""
    # TODO: XML dışa aktarım
    pass
