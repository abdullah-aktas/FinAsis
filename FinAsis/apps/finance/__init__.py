# -*- coding: utf-8 -*-
"""
Finansal işlemler, banka entegrasyonları ve finansal analiz araçlarını içeren uygulama.
...
Bu modüller doğrudan import edilebilir:
    from finance.accounting import ledger
    from finance.banking import transactions
    from finance.einvoice import generate_invoice
...
default_app_config = 'FinAsis.apps.finance.apps.FinanceConfig'