...
try:
    ...
    from FinAsis.apps.finance.models import BaseModel
    class AuditableMixin(models.Model):
        class Meta:
            abstract = True
from FinAsis.apps.accounting.models import Company
from FinAsis.apps.finance.accounting.models import Voucher
from FinAsis.apps.finance.models import Account
from FinAsis.apps.finance.accounting.models import Currency
from FinAsis.apps.finance.banking.models import BankAccount
from FinAsis.apps.accounting.models import Customer
from FinAsis.apps.accounting.models import Company as Supplier  # geçici eşleştirme
