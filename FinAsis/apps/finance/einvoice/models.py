...
try:
    from core.models import BaseModel, AuditableMixin, CompanyMixin  # type: ignore
except Exception:
...
from FinAsis.apps.finance.accounting.models import Voucher  # Account bu modülde kullanılmıyor
