...
from .views import admin_dashboard, user_list, company_list, invoice_list, user_detail, user_add, user_edit, user_delete, invoice_detail, invoice_add, invoice_edit, invoice_delete, admin_logs
