...
class AccountingSystem:
    ...
    def initialize_achievements(self):
        ...
        self.learning_manager.add_achievement(Achievement(
            id="muhasebe_uzmani",
    ...
    def initialize_inventory(self):
        ...
        self.inventory_manager.add_item(InventoryItem("INV001", "Örnek Ürün 1", 100, 50.0, 5000.0, "Elektronik", datetime.now()))
        self.inventory_manager.add_item(InventoryItem("INV002", "Örnek Ürün 2", 200, 25.0, 5000.0, "Giyim", datetime.now()))
        
    def initialize_tax_system(self):
        """Vergi sistemini başlatır"""
        self.tax_manager.add_record(TaxRecord(
            id=str(uuid.uuid4()),
            type="KDV",
            amount=0.0,
            period="2024-Q1",
    ...
    def get_learning_progress(self) -> Dict:
        ...
        return {
            ...
            "achievements": [a.__dict__ for a in self.learning_manager.get_achievements()]
        }
    ...
    def generate_financial_statements(self) -> Dict:
        ...
        income_statement = FinancialReportManager.generate_income_statement(self.accounts)
        ...
        ratios = {
            "current_ratio": FinancialRatios.calculate_current_ratio(total_assets, total_liabilities),
            "debt_to_equity": FinancialRatios.calculate_debt_to_equity(total_liabilities, total_equity),
            "profit_margin": FinancialRatios.calculate_profit_margin(net_income, total_revenue),
            "return_on_assets": FinancialRatios.calculate_return_on_assets(net_income, total_assets),
            "return_on_equity": FinancialRatios.calculate_return_on_equity(net_income, total_equity)
        }
        return {
