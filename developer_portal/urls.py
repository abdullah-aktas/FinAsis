...
urlpatterns = [
    ...
    path("keys/<uuid:pk>/rotate/", views.APIKeyRotateView.as_view(), name="api_key_rotate"),
    path("keys/<uuid:pk>/revoke/", views.APIKeyRevokeView.as_view(), name="api_key_revoke"),
