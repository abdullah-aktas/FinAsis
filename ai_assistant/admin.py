...
class AIModelAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "model_type", "version", "description")}),
        (
            _("Performans"),
            {"fields": ("accuracy", "parameters", "show_params", "last_trained")},
        ),
        (_("Durum"), {"fields": ("is_active", "created_at", "updated_at")}),
    )
    ordering = ("-created_at",)
...
class FinancialPredictionAdmin(admin.ModelAdmin):
    ...
    ordering = ("-created_at",)
    fieldsets = (
        (None, {"fields": ("user", "prediction_type", "model")}),
        (_("Veri"), {"fields": ("input_data", "prediction_result", "confidence")}),
        (_("Doğrulama"), {"fields": ("is_validated", "validation_notes")}),
        (_("Zaman Bilgisi"), {"fields": ("created_at", "updated_at")}),
    )
...
class AIFeedbackAdmin(admin.ModelAdmin):
    ...
    ordering = ("-created_at",)
    fieldsets = (
        (None, {"fields": ("user", "model", "rating")}),
        (_("Detaylar"), {"fields": ("feedback_text", "created_at")}),
    )
...
class SectorBenchmarkAdmin(admin.ModelAdmin):
    ...
    search_fields = ("sector_key", "display_name")
