...
from .models import AIModel, UserInteraction, FinancialPrediction, AIFeedback, FinancialReport, AnomalyDetection, TrendAnalysis, SectorBenchmark
...
class FinancialPredictionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('user', 'prediction_type', 'model')
        }),
        (_('Veri'), {
            'fields': ('input_data', 'prediction_result', 'confidence')
        }),
        (_('Doğrulama'), {
...
class AIFeedbackAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Detaylar'), {
            'fields': ('feedback_text', 'created_at')
        }),
    )
...
class SectorBenchmarkAdmin(admin.ModelAdmin):
    list_display = ("sector_key", "display_name", "margin_min", "current_ratio_min", "dte_max", "opex_ratio_max", "is_active")
