    ...
    try:
        ...
        analysis = {
            "bist100": {
                ...
                "change": (
                    (bist_data["Close"].iloc[-1] - bist_data["Close"].iloc[0])
                    / bist_data["Close"].iloc[0]
                )
                * 100,
            ...
            "usdtry": {
                ...
                "change": (
                    (usdtry_data["Close"].iloc[-1] - usdtry_data["Close"].iloc[0])
            ...
            "eurtry": {
                ...
                "change": (
                    (eurtry_data["Close"].iloc[-1] - eurtry_data["Close"].iloc[0])
        ...
        # Veritabanına kaydet
        MarketAnalysis.objects.create(analysis_data=analysis, timestamp=datetime.now())
