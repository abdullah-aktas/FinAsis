...
class SentimentAnalysisService:
    ...
    POSITIVE_KEYWORDS = [
        'memnun', 'teşekkür', 'harika', 'mükemmel', 'süper', 'başarılı', 
        'iyi', 'kaliteli', 'hızlı', 'güzel', 'çok iyi', 'beğendim',
        'tavsiye', 'profesyonel', 'yardımcı', 'işe yaradı', 'kesinlikle',
        'mutlu', 'sevindim', 'takdir', 'övgü', 'olumlu'
    ]
    
    NEGATIVE_KEYWORDS = [
        'kötü', 'berbat', 'sorun', 'problem', 'şikayet', 'memnun değil',
        'yavaş', 'geç', 'hata', 'yanlış', 'eksik', 'yetersiz',
        'başarısız', 'olmadı', 'çalışmıyor', 'bozuk', 'kırgın',
        'üzgün', 'pişman', 'tavsiye etmem', 'kullanmam'
    ]
    
    NEUTRAL_KEYWORDS = [
        'normal', 'idare eder', 'fena değil', 'orta', 'yeterli',
        'standart', 'bilgi', 'soru', 'nasıl'
    ]
    ...
    def get_sentiment_statistics(cls, user=None, days=30) -> Dict:
        ...
        by_source = queryset.values('source_type', 'sentiment').annotate(count=Count('id'))
