...
urlpatterns = [
    ...
    path('kb/ingest-internal/', kb_ingest_internal, name='ai_assistant_kb_ingest_internal'),
    # Voucher creation shortcuts (AI Assistant wrappers over accounting services)
    path('voucher/from-text/', voucher_from_text, name='ai_assistant_voucher_from_text'),
    path('voucher/from-voice/', voucher_from_voice, name='ai_assistant_voucher_from_voice'),
    path('voucher/from-document/', voucher_from_document, name='ai_assistant_voucher_from_document'),
