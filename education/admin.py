...
from .models import (
    CourseCategory, EnhancedCourse, LearningPath, PathCourse,
    Certificate, Announcement, LessonResource, StudentGoal,
    CourseReview, StudySession
)
...
class EnhancedCourseAdmin(admin.ModelAdmin):
    list_display = ('course', 'category', 'difficulty_level', 'estimated_hours', 'average_rating', 'is_published')
...
class LearningPathAdmin(admin.ModelAdmin):
    list_display = ('title', 'difficulty_level', 'estimated_weeks', 'created_by', 'is_active', 'created_at')
    search_fields = ('title', 'description')
...
class CertificateAdmin(admin.ModelAdmin):
    list_display = ('certificate_id', 'student', 'course', 'learning_path', 'certificate_type', 'final_score', 'issued_at', 'is_revoked')
    search_fields = ('certificate_id', 'student__username', 'course__name', 'verification_code')
...
class AnnouncementAdmin(admin.ModelAdmin):
    list_display = ('title', 'course', 'author', 'priority', 'is_published', 'notification_sent', 'created_at')
...
class LessonResourceAdmin(admin.ModelAdmin):
    list_display = ('title', 'lesson', 'resource_type', 'is_downloadable', 'requires_completion', 'uploaded_by', 'created_at')
    search_fields = ('title', 'description', 'lesson__title')
    list_filter = ('resource_type', 'is_downloadable', 'requires_completion', 'created_at')
    date_hierarchy = 'created_at'


@admin.register(StudentGoal)
class StudentGoalAdmin(admin.ModelAdmin):
    list_display = ('title', 'student', 'goal_type', 'status', 'target_date', 'current_progress', 'reminder_enabled')
...
class CourseReviewAdmin(admin.ModelAdmin):
    list_display = ('course', 'student', 'rating', 'is_approved', 'is_published', 'helpful_count', 'created_at')
...
class StudySessionAdmin(admin.ModelAdmin):
    list_display = ('student', 'course', 'lesson', 'started_at', 'duration_minutes', 'focus_score')
