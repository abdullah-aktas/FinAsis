...
from education.models import FinancialTermCard, LearningContent, Badge, Forum
...
class FinancialTermCardModelTest(TestCase):
    def test_create_card(self):
        card = FinancialTermCard.objects.create(
            term="Bilanço",
            description="Bir işletmenin mali durumu.",
            example="Örnek bilanço tablosu.",
        )
...
class ForumModelTest(TestCase):
    def test_create_forum(self):
        ...
        forum = Forum.objects.create(
            title="Genel Forum", description="Genel tartışmalar", created_by=user
        )
...
class LearningContentAPITest(TestCase):
    ...
    @unittest.skip("API endpoint not yet implemented")
