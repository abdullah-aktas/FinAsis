...
try:
    ...
    generate_token = getattr(education_models, 'generate_invitation_token')
except Exception:  # pragma: no cover - safe fallback for test envs
    import uuid
    def generate_token():
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=generate_token, max_length=64, unique=True
                    ),
                ),
                (
                    "status",
