...
Bu modül şu şekilde kullanılabilir:
    from apps.finance.accounting import accounts, vouchers, reports
...
İlişkili Modüller:
----------------
- apps.finance.banking    : Banka işlemleri
- apps.company            : Şirket bilgileri
- apps.finance.einvoice   : E-Fatura işlemleri
...
default_app_config = 'apps.finance.accounting.apps.AccountingConfig' 