...
class Company(models.Model):
    ...
    slug = models.SlugField(max_length=255, unique=True, blank=True, null=True, verbose_name="SEO Adresi")
...
class CostCenter(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='accounting_cost_centers', verbose_name="Şirket")
    ...
    center_type = models.CharField(max_length=20, choices=COST_CENTER_TYPES, verbose_name="Tip")
    description = models.TextField(blank=True, verbose_name="Açıklama")
    parent = models.ForeignKey('self', null=True, blank=True, on_delete=models.SET_NULL, related_name='sub_centers', verbose_name="Üst Maliyet Merkezi")
    is_active = models.BooleanField(default=True, verbose_name="Aktif")
    budget_amount = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True, verbose_name="Bütçe")
    manager = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name='managed_cost_centers', verbose_name="Sorumlu")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class CostAllocation(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='cost_allocations', verbose_name="Şirket")
    cost_center = models.ForeignKey(CostCenter, on_delete=models.CASCADE, related_name='allocations', verbose_name="Maliyet Merkezi")
    allocation_date = models.DateField(verbose_name="Dağıtım Tarihi")
    allocation_method = models.CharField(max_length=20, choices=ALLOCATION_METHODS, default='direct')
    amount = models.DecimalField(max_digits=15, decimal_places=2, verbose_name="Tutar")
    percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Dağıtım Yüzdesi")
    description = models.TextField(blank=True, verbose_name="Açıklama")
    
    # Kaynak bilgisi
    source_expense = models.ForeignKey(Expense, null=True, blank=True, on_delete=models.SET_NULL, related_name='cost_allocations')
    source_transaction = models.ForeignKey(BankTransaction, null=True, blank=True, on_delete=models.SET_NULL, related_name='cost_allocations')
...
class CostReport(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='cost_reports', verbose_name="Şirket")
    ...
    # Analiz sonuçları
    total_costs = models.DecimalField(max_digits=18, decimal_places=2, default=0, verbose_name="Toplam Maliyetler")
    budgeted_costs = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True, verbose_name="Bütçelenen Maliyetler")
    variance = models.DecimalField(max_digits=18, decimal_places=2, null=True, blank=True, verbose_name="Varyans")
    variance_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True, verbose_name="Varyans %")
    
    # Detay veriler (JSON)
    cost_breakdown = models.JSONField(default=dict, blank=True, verbose_name="Maliyet Dağılımı")
    center_analysis = models.JSONField(default=list, blank=True, verbose_name="Merkez Bazlı Analiz")
    recommendations = models.JSONField(default=list, blank=True, verbose_name="Öneriler")
...
class AccountingAudit(models.Model):
    ...
    company = models.ForeignKey(Company, on_delete=models.CASCADE, related_name='accounting_audits', verbose_name="Denetlenen Şirket")
    audit_type = models.CharField(max_length=30, choices=AUDIT_TYPES, verbose_name="Denetim Tipi")
    audit_name = models.CharField(max_length=200, verbose_name="Denetim Adı")
    fiscal_year = models.IntegerField(verbose_name="Mali Yıl")
    fiscal_period = models.CharField(max_length=10, blank=True, verbose_name="Dönem")  # Q1, Q2, vb.
    
    # Denetim ekibi
    lead_auditor = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='led_audits', verbose_name="Baş Denetçi")
    audit_team = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name='audit_participations', blank=True, verbose_name="Denetim Ekibi")
    
    # Tarihler
    planned_start = models.DateField(verbose_name="Planlanan Başlangıç")
    planned_end = models.DateField(verbose_name="Planlanan Bitiş")
    actual_start = models.DateField(null=True, blank=True, verbose_name="Gerçekleşen Başlangıç")
    actual_end = models.DateField(null=True, blank=True, verbose_name="Gerçekleşen Bitiş")
    
    # Durum ve sonuç
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='planning')
    audit_opinion = models.CharField(max_length=20, choices=OPINION_CHOICES, default='pending', verbose_name="Denetim Görüşü")
    overall_score = models.IntegerField(null=True, blank=True, verbose_name="Genel Skor (0-100)")
    ...
    # Dosyalar
    audit_report = models.FileField(upload_to='audit_reports/', null=True, blank=True, verbose_name="Denetim Raporu")
    working_papers = models.FileField(upload_to='audit_workpapers/', null=True, blank=True, verbose_name="Çalışma Kağıtları")
...
class AuditFinding(models.Model):
    ...
    audit = models.ForeignKey(AccountingAudit, on_delete=models.CASCADE, related_name='findings', verbose_name="Denetim")
    finding_number = models.CharField(max_length=20, verbose_name="Bulgu No")
    finding_type = models.CharField(max_length=20, choices=FINDING_TYPES, verbose_name="Bulgu Tipi")
    severity = models.CharField(max_length=20, choices=SEVERITY_LEVELS, default='medium', verbose_name="Önem Derecesi")
    ...
    # Finansal etki
    financial_impact = models.DecimalField(max_digits=15, decimal_places=2, null=True, blank=True, verbose_name="Mali Etki")
    
    # İlişkili kayıtlar
    related_account = models.ForeignKey(GLAccount, null=True, blank=True, on_delete=models.SET_NULL, verbose_name="İlgili Hesap")
    related_invoice = models.ForeignKey(Invoice, null=True, blank=True, on_delete=models.SET_NULL, verbose_name="İlgili Fatura")
    related_expense = models.ForeignKey(Expense, null=True, blank=True, on_delete=models.SET_NULL, verbose_name="İlgili Gider")
    
    # Düzeltici aksiyon
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='open')
    corrective_action = models.TextField(blank=True, verbose_name="Düzeltici Aksiyon")
    responsible_person = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name='responsible_findings', verbose_name="Sorumlu Kişi")
    target_resolution_date = models.DateField(null=True, blank=True, verbose_name="Hedef Çözüm Tarihi")
    actual_resolution_date = models.DateField(null=True, blank=True, verbose_name="Gerçekleşen Çözüm Tarihi")
    
    identified_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='identified_findings')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class AuditEvidence(models.Model):
    ...
    finding = models.ForeignKey(AuditFinding, on_delete=models.CASCADE, related_name='evidences', verbose_name="Bulgu")
    evidence_type = models.CharField(max_length=20, choices=EVIDENCE_TYPES, verbose_name="Kanıt Tipi")
    title = models.CharField(max_length=200, verbose_name="Kanıt Başlığı")
    description = models.TextField(blank=True, verbose_name="Açıklama")
    
    # Dosya
    file = models.FileField(upload_to='audit_evidence/', null=True, blank=True, verbose_name="Kanıt Dosyası")
    ...
    collected_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name='collected_evidence')
...
class CostVarianceAnalysis(models.Model):
    ...
    cost_center = models.ForeignKey(CostCenter, on_delete=models.CASCADE, related_name='variance_analyses')
    analysis_period = models.CharField(max_length=20, verbose_name="Analiz Dönemi")  # 2024-01, 2024-Q1
    
    # Bütçe
    budgeted_amount = models.DecimalField(max_digits=15, decimal_places=2, verbose_name="Bütçelenen")
    actual_amount = models.DecimalField(max_digits=15, decimal_places=2, verbose_name="Gerçekleşen")
    
    # Varyans
    variance_amount = models.DecimalField(max_digits=15, decimal_places=2, verbose_name="Varyans Tutarı")
    variance_percentage = models.DecimalField(max_digits=5, decimal_places=2, verbose_name="Varyans %")
    variance_type = models.CharField(max_length=20, verbose_name="Varyans Tipi")  # favorable, unfavorable
    
    # Analiz
    cause_analysis = models.TextField(blank=True, verbose_name="Sebep Analizi")
    corrective_actions = models.JSONField(default=list, blank=True, verbose_name="Düzeltici Aksiyonlar")
    
    analyzed_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL)
    created_at = models.DateTimeField(auto_now_add=True)
    ...
    def __str__(self):
        return f"{self.cost_center.name} - {self.analysis_period} ({self.variance_type})"