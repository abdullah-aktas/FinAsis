...
from ..services.reports import (
    generate_kdv_report,
    generate_muhtasar_report,
    generate_babs_report,
    export_report_to_excel,
    export_report_to_pdf,
    generate_yevmiye_defteri,
    generate_kebir_defteri,
    generate_mizan_defteri,
    generate_envanter_defteri,
    generate_kasa_defteri,
    generate_demirbas_defteri,
    generate_bilanco,
...
def declaration_report_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request, "accounting/declaration_report_list.html", {"companies": companies}
    )
...
def kdv_report_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/kdv_report.html",
        {"df": df, "period": period, "company": company, "companies": companies},
    )
...
def muhtasar_report_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/muhtasar_report.html",
        {"df": df, "period": period, "company": company, "companies": companies},
    )
...
def ar_aging_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        ...
        {"df": df, "company": company, "companies": companies},
    )
...
def yevmiye_defteri_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/yevmiye_defteri.html",
        {
            "df": df,
            "year": year,
            "month": month,
...
def envanter_defteri_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/envanter_defteri.html",
        {
            "df": df,
            "year": year,
            "month": month,
...
def demirbas_defteri_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/demirbas_defteri.html",
        {"df": df, "year": year, "company": company, "companies": companies},
    )
...
def financial_analysis_view(request: HttpRequest) -> HttpResponse:
    ...
    return render(
        request,
        "accounting/financial_analysis.html",
        {
            "ratios": ratios,
            "trends": trends,
            "advice": advice,
...
def variance_analysis_view(request: HttpRequest) -> HttpResponse:
    ...
    scenario = (
        PlanningScenario.objects.filter(company=company, id=scenario_id).first()
        if scenario_id
        else PlanningScenario.objects.filter(company=company).first()
    )
    ...
    df = pd.DataFrame(
        [
            {
                "Kalem": "Gelir",
                "Gerçek": float(inv_total),
                "Plan": plan_revenue,
                "Sapma": float(inv_total) - plan_revenue,
            },
            {
                "Kalem": "Gider",
                "Gerçek": float(exp_total),
                "Plan": plan_expense,
                "Sapma": float(exp_total) - plan_expense,
            },
            {
                "Kalem": "Kar",
                "Gerçek": actual_profit,
                "Plan": plan_profit,
                "Sapma": actual_profit - plan_profit,
            },
        ]
    )
    return render(
        request,
        "accounting/variance_analysis.html",
        {
            "df": df,
            "company": company,
            "companies": companies,
