...
def bankaccount_list(request: HttpRequest) -> HttpResponse:
    ...
    return render(request, 'accounting/bankaccount_list.html', {'bankaccounts': bankaccounts})
...
def bankaccount_detail(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/bankaccount_detail.html', {'bankaccount': bankaccount})
...
def bankaccount_update(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    return render(request, 'accounting/bankaccount_form.html', {'form': form, 'bankaccount': bankaccount})
...
def bankaccount_delete(request: HttpRequest, pk: int) -> HttpResponse:
    ...
    if request.method == 'POST':
        bankaccount.delete()
        return redirect('accounting:bankaccount_list')
    return render(request, 'accounting/bankaccount_confirm_delete.html', {'bankaccount': bankaccount}) 