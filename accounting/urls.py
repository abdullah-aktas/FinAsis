...
urlpatterns = [
    ...
    path('sirketler/<slug:slug>/ai-ozet/', views.company_ai_summary, name='company_ai_summary'),

    # Legacy company URLs (permanent redirects)
    path('companies/', RedirectView.as_view(pattern_name='accounting:company_list', permanent=True)),
    path('companies/create/', RedirectView.as_view(pattern_name='accounting:company_create', permanent=True)),
    path('companies/<int:pk>/', views.company_detail_redirect, name='company_detail_legacy'),
    path('companies/<int:pk>/update/', views.company_update_redirect, name='company_update_legacy'),
    path('companies/<int:pk>/delete/', views.company_delete_redirect, name='company_delete_legacy'),
    path('companies/<int:pk>/pdf/', views.company_pdf_redirect, name='company_pdf_legacy'),
    path('companies/<int:pk>/ai-summary/', views.company_ai_summary_redirect, name='company_ai_summary_legacy'),
    ...
    path('api/invoices/bulk-action/', views.api_invoice_bulk_action, name='api_invoice_bulk_action'),
    ...
    path('report/', RedirectView.as_view(pattern_name='accounting:report_redirect', permanent=True)),
    path('report/summary/', RedirectView.as_view(pattern_name='accounting:summary_report', permanent=True)),
    path('report/chart/', RedirectView.as_view(pattern_name='accounting:chart_data', permanent=True)),
    path('report/dashboard/', RedirectView.as_view(pattern_name='accounting:dashboard', permanent=True)),
    path('report/summary-pdf/', RedirectView.as_view(pattern_name='accounting:summary_report_pdf', permanent=True)),
    ...
    path('finansal-senaryolar/<int:pk>/', views.scenario_detail, name='scenario_detail'),
    path('finansal-senaryolar/<int:pk>/duzenle/', views.scenario_update, name='scenario_update'),
    path('finansal-senaryolar/<int:pk>/sil/', views.scenario_delete, name='scenario_delete'),
    path('scenarios/', RedirectView.as_view(pattern_name='accounting:scenario_list', permanent=True)),
    path('scenarios/create/', RedirectView.as_view(pattern_name='accounting:scenario_create', permanent=True)),
    path('scenarios/<int:pk>/', RedirectView.as_view(pattern_name='accounting:scenario_detail', permanent=True)),
    path('scenarios/<int:pk>/update/', RedirectView.as_view(pattern_name='accounting:scenario_update', permanent=True)),
    path('scenarios/<int:pk>/delete/', RedirectView.as_view(pattern_name='accounting:scenario_delete', permanent=True)),
    ...
    path('auto-book/', RedirectView.as_view(pattern_name='accounting:auto_book', permanent=True)),
    path('rules/', RedirectView.as_view(pattern_name='accounting:rule_manager', permanent=True)),
