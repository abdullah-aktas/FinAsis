...
class ThemeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Temel Bilgiler", {"fields": ("name", "slug", "description", "thumbnail")}),
        (
            "Renkler",
            {
                "fields": (
        ...
        ("Tipografi", {"fields": ("font_family", "font_size_base")}),
        ("Layout", {"fields": ("border_radius", "box_shadow")}),
        ("Özel", {"fields": ("custom_css",), "classes": ("collapse",)}),
        ("Durum", {"fields": ("is_active", "is_default", "created_by")}),
    )
...
class BannerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("İçerik", {"fields": ("title", "message", "banner_type", "position")}),
        ("Aksiyon", {"fields": ("button_text", "button_url")}),
        (
            "Hedefleme",
            {"fields": ("show_to_guests", "show_to_authenticated", "target_roles")},
        ),
        ("Zamanlama", {"fields": ("start_date", "end_date", "priority")}),
        ("Ayarlar", {"fields": ("is_active", "is_dismissible", "created_by")}),
        (
            "İstatistikler",
...
class PageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Tema & Özelleştirme",
            {"fields": ("theme", "custom_css", "custom_js"), "classes": ("collapse",)},
        ),
        ("Yayın", {"fields": ("is_published", "published_at", "author")}),
        ("İstatistikler", {"fields": ("view_count",), "classes": ("collapse",)}),
    )
