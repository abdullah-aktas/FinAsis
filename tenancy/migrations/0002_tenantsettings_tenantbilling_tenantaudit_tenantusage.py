    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "enabled_modules",
                    models.JSONField(default=list, verbose_name="Aktif Modüller"),
                ),
                (
                    "feature_limits",
                    models.JSONField(
                ...
                (
                    "max_users",
                    models.IntegerField(default=10, verbose_name="Maksimum Kullanıcı"),
                ),
                (
                    "max_storage_mb",
                    models.IntegerField(
                ...
                (
                    "contact_email",
                    models.EmailField(
                        blank=True, max_length=254, verbose_name="İletişim E-posta"
                    ),
                ),
                (
                    "contact_phone",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="İletişim Telefon"
                    ),
                ),
                (
                    "timezone",
                ...
                (
                    "ip_whitelist",
                    models.JSONField(
                        blank=True, default=list, verbose_name="IP Beyaz Liste"
                    ),
                ),
                (
                    "require_2fa",
                    models.BooleanField(default=False, verbose_name="2FA Zorunlu"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(verbose_name="Fatura Dönemi Başlangıç"),
                ),
                (
                    "billing_period_end",
                    models.DateField(verbose_name="Fatura Dönemi Bitiş"),
                ),
                (
                    "base_amount",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Taban Tutar"
                    ),
                ),
                (
                    "usage_amount",
                ...
                (
                    "billing_details",
                    models.JSONField(default=dict, verbose_name="Fatura Detayları"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "invoices_created",
                    models.IntegerField(default=0, verbose_name="Oluşturulan Fatura"),
                ),
                (
                    "transactions_created",
                    models.IntegerField(default=0, verbose_name="Oluşturulan İşlem"),
                ),
                (
                    "reports_generated",
                    models.IntegerField(default=0, verbose_name="Oluşturulan Rapor"),
                ),
                (
                    "module_usage",
                    models.JSONField(
                        blank=True, default=dict, verbose_name="Modül Kullanımı"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
