...
from .models import Customer, Opportunity, Activity, Sale, Report, Document, Campaign, CampaignUsage, ReferralProgram, PremiumPackage, ConsultingService, TrainingProgram, APIPricing, ServiceSubscription, LoyaltyProgram, LoyaltyLevel, CustomerLoyalty, SeasonalCampaign, PartnershipProgram, Partner
