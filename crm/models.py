...
class ReferralProgram(models.Model):
    referrer = models.ForeignKey('Customer', on_delete=models.CASCADE, related_name='referrals_given')
...
class CustomerLoyalty(models.Model):
    ...
    customer = models.ForeignKey('Customer', on_delete=models.CASCADE, related_name='loyalty_info')
