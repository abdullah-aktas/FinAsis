...
class MockIntegration(models.Model):
    ...
    integration_type = models.CharField(
        max_length=20, choices=INTEGRATION_TYPES, verbose_name="Entegrasyon Tipi"
    )
    ...
    response_delay_ms = models.IntegerField(
        default=100, verbose_name="Yanıt Gecikmesi (ms)"
    )

    # Başarı oranı
    success_rate = models.IntegerField(
        default=100, verbose_name="Başarı Oranı (%)", help_text="0-100"
    )
