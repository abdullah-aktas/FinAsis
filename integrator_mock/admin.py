...
class MockIntegrationAdmin(admin.ModelAdmin):
    list_display = ('name', 'integration_type', 'success_rate', 'response_delay_ms', 'is_active', 'created_at')
...
class MockRequestAdmin(admin.ModelAdmin):
    list_display = ('integration', 'request_method', 'request_path', 'response_status', 'response_time_ms', 'user', 'created_at')
...
class MockScenarioAdmin(admin.ModelAdmin):
    list_display = ('name', 'integration', 'response_code', 'priority', 'is_active', 'usage_count')
