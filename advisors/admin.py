...
class AdvisorProfileAdmin(admin.ModelAdmin):
    ...
    readonly_fields = (
        ...
        "created_at",
        "updated_at",
        "client_count_display",
    )
    date_hierarchy = "verified_at"

    fieldsets = (
        (_("Kullanıcı Bilgisi"), {"fields": ("user", "type")}),
        (
        ...
        (_("Durum"), {"fields": ("verified_at", "is_active")}),
        (
            _("İstatistikler"),
            {"fields": ("client_count_display",), "classes": ("collapse",)},
        ),
        (
            _("Bilgiler"),
    ...
    def unverify_advisors(self, request, queryset):
        count = queryset.filter(verified_at__isnull=False).update(verified_at=None)
...
class TaxpayerProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Temel Bilgiler"), {"fields": ("name", "vkn_tckn", "mersis_no")}),
        (_("Şirket Bağlantısı"), {"fields": ("company",)}),
        (
            _("İstatistikler"),
            {"fields": ("advisor_count_display",), "classes": ("collapse",)},
        ),
        (
            _("Bilgiler"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
...
class EngagementAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Taraflar"), {"fields": ("advisor", "taxpayer")}),
        (_("İş Kapsamı"), {"fields": ("scope", "status")}),
        (
            _("Bilgiler"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class AdvisorServiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Fiyatlandırma"), {"fields": ("pricing_model", "price", "currency")}),
...
class ConsultationSessionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Taraflar"), {"fields": ("advisor", "taxpayer", "session_type")}),
        (
            _("Zamanlama"),
            {
                "fields": (
        ...
        (_("İçerik"), {"fields": ("agenda", "notes", "action_items")}),
        (_("Takip"), {"fields": ("follow_up_required", "follow_up_date")}),
        (
            _("Faturalandırma"),
...
class AdvisorReportAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Dönem"), {"fields": ("period_start", "period_end")}),
        (_("Dosyalar"), {"fields": ("report_file", "attachments")}),
        (
            _("Onay ve Teslimat"),
...
class ClientContractAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("İçerik"), {"fields": ("scope_of_work", "terms_and_conditions")}),
        (_("Finansal"), {"fields": ("contract_value", "payment_terms")}),
        (
            _("Tarihler"),
            {
                "fields": (
        ...
        (_("Durum"), {"fields": ("status", "signed_at", "is_active")}),
        (_("Dosyalar"), {"fields": ("contract_file", "signed_contract")}),
        (
            _("Bilgiler"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class AdvisorTimeTrackingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Taraflar"), {"fields": ("advisor", "taxpayer", "session")}),
        (
            _("Zaman"),
            {
                "fields": (
        ...
        (_("İş Detayı"), {"fields": ("task_description", "service_category")}),
        (
            _("Faturalandırma"),
            {
                "fields": (
...
class ClientDocumentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Dosya"), {"fields": ("file", "file_size_display", "document_date")}),
        (
            _("Etiketler ve Güvenlik"),
            {"fields": ("tags", "is_confidential", "access_log_display")},
        ),
        (_("Bilgiler"), {"fields": ("uploaded_at",), "classes": ("collapse",)}),
    )
...
class AdvisorTaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Öncelik ve Tarih"), {"fields": ("priority", "due_date", "days_until_due")}),
        (_("Durum"), {"fields": ("is_completed", "completed_at", "completion_notes")}),
        (_("Bildirimler"), {"fields": ("reminder_sent", "reminder_date")}),
        (_("Bilgiler"), {"fields": ("created_at",), "classes": ("collapse",)}),
    )
