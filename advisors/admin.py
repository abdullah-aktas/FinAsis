...
from .models import (
    AdvisorProfile, AdvisorRegistrySource, TaxpayerProfile, Engagement,
    AdvisorService, ConsultationSession, AdvisorReport, ClientContract,
    AdvisorTimeTracking, ClientDocument, AdvisorTask
)
...
class AdvisorServiceAdmin(admin.ModelAdmin):
    list_display = ('service_name', 'advisor', 'service_type', 'pricing_model', 'price', 'is_active')
...
class ConsultationSessionAdmin(admin.ModelAdmin):
    list_display = ('taxpayer', 'advisor', 'session_type', 'scheduled_date', 'status', 'billable')
...
class ClientContractAdmin(admin.ModelAdmin):
    list_display = ('contract_number', 'taxpayer', 'advisor', 'contract_type', 'status', 'start_date', 'end_date')
...
class AdvisorTimeTrackingAdmin(admin.ModelAdmin):
    list_display = ('advisor', 'taxpayer', 'date', 'duration_minutes', 'total_amount', 'billable', 'invoiced')
...
class ClientDocumentAdmin(admin.ModelAdmin):
    list_display = ('title', 'taxpayer', 'document_type', 'uploaded_by', 'is_confidential', 'uploaded_at')
...
class AdvisorTaskAdmin(admin.ModelAdmin):
    list_display = ('title', 'advisor', 'taxpayer', 'task_type', 'priority', 'due_date', 'is_completed')
