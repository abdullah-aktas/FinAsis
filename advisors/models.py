...
class AdvisorService(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='services')
    service_type = models.CharField(max_length=30, choices=SERVICE_TYPES, verbose_name="Hizmet Tipi")
...
class ConsultationSession(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='sessions')
    taxpayer = models.ForeignKey(TaxpayerProfile, on_delete=models.CASCADE, related_name='sessions')
...
class AdvisorReport(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='reports')
    taxpayer = models.ForeignKey(TaxpayerProfile, on_delete=models.CASCADE, related_name='advisor_reports')
    ...
    approved_by = models.ForeignKey(settings.AUTH_USER_MODEL, null=True, blank=True, on_delete=models.SET_NULL, related_name='approved_advisor_reports')
...
class ClientContract(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='contracts')
    taxpayer = models.ForeignKey(TaxpayerProfile, on_delete=models.CASCADE, related_name='contracts')
    ...
    # Ücret
    contract_value = models.DecimalField(max_digits=12, decimal_places=2, verbose_name="Sözleşme Bedeli")
    ...
    renewal_date = models.DateField(null=True, blank=True, verbose_name="Yenileme Tarihi")
    ...
    # Dosyalar
    contract_file = models.FileField(upload_to='advisor_contracts/', null=True, blank=True)
    signed_contract = models.FileField(upload_to='advisor_contracts/signed/', null=True, blank=True)
...
class AdvisorTimeTracking(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='time_entries')
    taxpayer = models.ForeignKey(TaxpayerProfile, on_delete=models.CASCADE, related_name='time_entries')
    session = models.ForeignKey(ConsultationSession, null=True, blank=True, on_delete=models.SET_NULL, related_name='time_entries')
    ...
    # Faturalandırma
    billable = models.BooleanField(default=True)
    hourly_rate = models.DecimalField(max_digits=10, decimal_places=2, verbose_name="Saatlik Ücret")
...
class ClientDocument(models.Model):
    ...
    taxpayer = models.ForeignKey(TaxpayerProfile, on_delete=models.CASCADE, related_name='documents')
    uploaded_by = models.ForeignKey(AdvisorProfile, on_delete=models.SET_NULL, null=True, related_name='uploaded_documents')
    
    document_type = models.CharField(max_length=30, choices=DOCUMENT_TYPES)
    title = models.CharField(max_length=200, verbose_name="Başlık")
    description = models.TextField(blank=True, verbose_name="Açıklama")
    file = models.FileField(upload_to='client_documents/', verbose_name="Dosya")
    file_size = models.IntegerField(null=True, blank=True, verbose_name="Dosya Boyutu (bytes)")
...
class AdvisorTask(models.Model):
    ...
    advisor = models.ForeignKey(AdvisorProfile, on_delete=models.CASCADE, related_name='tasks')
    taxpayer = models.ForeignKey(TaxpayerProfile, null=True, blank=True, on_delete=models.CASCADE, related_name='advisor_tasks')
