...
class Role(models.Model):
    ...
    type = models.CharField(
        _("Rol Tipi"), max_length=10, choices=ROLE_TYPE_CHOICES, default=CUSTOM
    )
...
class UserRole(models.Model):
    ...
    user = models.ForeignKey(
        User, models.CASCADE, verbose_name=_("Kullanıcı"), related_name="user_roles"
    )
    role = models.ForeignKey(
        Role, models.CASCADE, verbose_name=_("Rol"), related_name="user_roles"
    )
    is_active = models.BooleanField(_("Aktif mi?"), default=True)
    created_at = models.DateTimeField(_("Oluşturulma tarihi"), auto_now_add=True)
    updated_at = models.DateTimeField(_("Güncellenme tarihi"), auto_now=True)
...
class PermissionGroup(models.Model):
    ...
    permissions = models.ManyToManyField(
        Permission, related_name="groups", blank=True, verbose_name=_("Yetkiler")
    )
...
class TemporaryPermission(models.Model):
    ...
    permission = models.ForeignKey(
        Permission, on_delete=models.CASCADE, verbose_name=_("Yetki")
    )
...
class PermissionAudit(models.Model):
    ...
    result = models.CharField(
        max_length=20,
        choices=[("ALLOWED", _("İzin Verildi")), ("DENIED", _("Reddedildi"))],
        blank=True,
        verbose_name=_("Sonuç"),
    )
