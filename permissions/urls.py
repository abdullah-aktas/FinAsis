...
router.register(
    r"api/user-permissions", views.UserPermissionViewSet, basename="api-userpermission"
)
...
urlpatterns = [
    ...
    path(
        "user-roles/<int:pk>/",
        views.UserRoleDetailView.as_view(),
        name="userrole_detail",
    ),
    path(
        "user-roles/create/", views.UserRoleCreateView.as_view(), name="userrole_create"
    ),
    path(
        "user-roles/<int:pk>/update/",
