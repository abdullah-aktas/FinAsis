...
class PartnerListingAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Genel Bilgiler"), {"fields": ("name", "slug", "tagline", "summary", "description")}),
        (_("Kategori ve Etiket"), {"fields": ("category", "badge_label")}),
        (_("İçerik"), {"fields": ("website", "contact_email", "logo_url", "capabilities", "integrations", "regions")}),
...
class PartnerApplicationEventInline(admin.TabularInline):
    ...
    extra = 0
    readonly_fields = ("action", "notes", "from_status", "to_status", "actor", "created_at")


@admin.register(PartnerApplication)
class PartnerApplicationAdmin(admin.ModelAdmin):
    list_display = ("company_name", "contact_name", "status", "created_at", "assigned_to")
    ...
    fieldsets = (
        (_("Şirket"), {"fields": ("company_name", "brand_name", "website", "country", "city", "team_size")}),
        (_("İletişim"), {"fields": ("contact_name", "contact_email", "contact_phone", "job_title")}),
        (_("Uyum ve Entegrasyon"), {"fields": ("primary_category", "categories", "integration_focus")}),
        (_("Detaylar"), {"fields": ("product_notes", "message", "go_live_timeline", "revenue_model", "sandbox_needs")}),
        (_("Durum"), {"fields": ("status", "assigned_to", "decision_notes", "reviewed_at")}),
...
class PartnerApplicationEventAdmin(admin.ModelAdmin):
    list_display = ("application", "action", "from_status", "to_status", "actor", "created_at")
