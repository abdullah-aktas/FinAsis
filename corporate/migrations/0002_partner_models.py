    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Bootstrap ikon adı veya özel sınıf.",
                        max_length=80,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Örn. #0AAE94 veya tailwind sınıfı.",
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "logo_url",
                    models.URLField(
                        blank=True, help_text="CDN veya medya kütüphanesi URL'si."
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="events",
                        to="corporate.partnerapplication",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="applications", to="corporate.partnercategory"
            ),
        ),
    ]
