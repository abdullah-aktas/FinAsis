...
urlpatterns = [
    ...
    # AJAX endpoints
    path(
        "ajax/test-connection/", views.ajax_test_connection, name="ajax_test_connection"
    ),
    path(
        "ajax/retry-submission/<int:submission_id>/",
        views.ajax_retry_submission,
        name="ajax_retry_submission",
    ),
    path(
