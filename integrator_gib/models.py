...
class GIBSubmissionLog(models.Model):
    ...
    response_data = models.JSONField(default=dict, blank=True, verbose_name="Yanıt Verisi")
    response_xml = models.TextField(blank=True, verbose_name="Yanıt XML")
    
    # GİB referans
    gib_reference_number = models.CharField(max_length=100, blank=True, verbose_name="GİB Referans No")
    gib_tracking_id = models.CharField(max_length=100, blank=True, verbose_name="GİB Takip No")
    ...
    # Metadata
    integrator = models.ForeignKey(IntegratorConfig, on_delete=models.SET_NULL, null=True, verbose_name="Entegratör")
...
class GIBCertificate(models.Model):
    ...
    certificate_type = models.CharField(max_length=20, choices=CERTIFICATE_TYPES, verbose_name="Sertifika Tipi")
    ...
    password_hash = models.CharField(max_length=255, blank=True, verbose_name="Şifre Hash")
