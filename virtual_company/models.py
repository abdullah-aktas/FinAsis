...
class CompanyLeaderboard(models.Model):
    ...
    company = models.OneToOneField(VirtualCompany, on_delete=models.CASCADE, related_name='leaderboard_stats')
...
class CompanyAchievement(models.Model):
    ...
    company = models.ForeignKey(VirtualCompany, on_delete=models.CASCADE, related_name='achievements')
