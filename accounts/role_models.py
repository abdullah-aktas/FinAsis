...
class UserRole(models.Model):
    ...
    can_manage_companies = models.BooleanField(default=False, verbose_name="Şirket Yönetimi")
    can_view_all_finances = models.BooleanField(default=False, verbose_name="Tüm Mali Verileri Görme")
    can_edit_finances = models.BooleanField(default=False, verbose_name="Mali Düzenleme")
    can_approve_transactions = models.BooleanField(default=False, verbose_name="İşlem Onaylama")
    can_generate_reports = models.BooleanField(default=False, verbose_name="Rapor Oluşturma")
    ...
    can_use_blockchain = models.BooleanField(default=False, verbose_name="Blockchain Modülü")
...
class UserSubscription(models.Model):
    ...
    next_billing_date = models.DateTimeField(
        ...
        verbose_name="Sonraki Faturalama"
    )
    ...
    current_month_transactions = models.IntegerField(
        default=0,
        verbose_name="Bu Ay İşlem Sayısı"
    )
    total_transactions = models.IntegerField(
        default=0,
        verbose_name="Toplam İşlem"
    )
    storage_used_mb = models.IntegerField(
        default=0,
        verbose_name="Kullanılan Depolama (MB)"
    )
    
    # Metadata
    auto_renew = models.BooleanField(
        default=True,
        verbose_name="Otomatik Yenileme"
    )
    ...
    def can_perform_action(self, action_type):
        ...
        if action_type == 'transaction':
            return (
                self.plan.max_transactions == -1 or 
                self.current_month_transactions < self.plan.max_transactions
            )
...
class RoleBasedUserProfile(models.Model):
    ...
    last_password_change = models.DateTimeField(
        auto_now_add=True,
        verbose_name="Son Şifre Değişikliği"
    )
    ...
    def can_manage_user(self, target_user):
        ...
        try:
            ...
            return (
                self.role.can_manage_users and
                self.role.hierarchy_level < target_profile.role.hierarchy_level
            )
        except:
            return False
