...
from .admin_roles_fixed import (
    UserRoleAdmin, SubscriptionPlanAdmin, UserSubscriptionAdmin, 
    UserProfileAdmin as RoleUserProfileAdmin, EnhancedUserAdmin,
    role_statistics_view, subscription_analytics_view
)
from .role_models import UserRole, SubscriptionPlan, UserSubscription, RoleBasedUserProfile as RoleUserProfile
...
class CustomUserAdmin(UserAdmin):
    model = CustomUser
    list_display = ['username', 'email', 'get_user_type_display', 'company', 'role', 'is_staff', 'is_active']
...
from .models import (
    UserProfile, UserActivity, LoginHistory, UserNotification,
    TwoFactorAuth, PasswordHistory, UserSession, UserPreference
)

@admin.register(UserProfile)
class UserProfileAdmin(admin.ModelAdmin):
    list_display = ('user', 'phone', 'city', 'country', 'language', 'profile_views', 'last_profile_update')
...
class LoginHistoryAdmin(admin.ModelAdmin):
    list_display = ('user', 'status', 'ip_address', 'device_type', 'browser', 'country', 'two_factor_used', 'login_at')
...
class UserNotificationAdmin(admin.ModelAdmin):
    list_display = ('user', 'title', 'notification_type', 'priority', 'is_read', 'category', 'created_at')
    search_fields = ('user__username', 'title', 'message')
    list_filter = ('notification_type', 'priority', 'is_read', 'category', 'module', 'created_at')
    date_hierarchy = 'created_at'
...
class TwoFactorAuthAdmin(admin.ModelAdmin):
    list_display = ('user', 'is_enabled', 'method', 'enabled_at', 'last_used_at', 'total_uses')
...
class UserSessionAdmin(admin.ModelAdmin):
    list_display = ('user', 'ip_address', 'device_name', 'is_active', 'last_activity', 'created_at', 'expires_at')
...
class UserPreferenceAdmin(admin.ModelAdmin):
    list_display = ('user', 'theme', 'email_notifications', 'push_notifications', 'session_timeout', 'items_per_page')
    search_fields = ('user__username',)
    list_filter = ('theme', 'email_notifications', 'push_notifications', 'require_password_change')
