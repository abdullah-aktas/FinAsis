...
class UserProfile(models.Model):
    ...
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='profile', verbose_name="Kullanıcı")
    
    # Kişisel bilgiler
    phone = models.CharField(max_length=20, blank=True, verbose_name="Telefon")
    bio = models.TextField(blank=True, verbose_name="Hakkında")
    avatar = models.ImageField(upload_to='avatars/', null=True, blank=True, verbose_name="Profil Fotoğrafı")
...
class UserActivity(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='activities', verbose_name="Kullanıcı")
    activity_type = models.CharField(max_length=30, choices=ACTIVITY_TYPES, verbose_name="Aktivite Tipi")
...
class LoginHistory(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='login_history', verbose_name="Kullanıcı")
    status = models.CharField(max_length=10, choices=STATUS_CHOICES, default='success', verbose_name="Durum")
    ...
    failure_reason = models.CharField(max_length=200, blank=True, verbose_name="Başarısızlık Sebebi")
    ...
    session_duration = models.IntegerField(null=True, blank=True, verbose_name="Oturum Süresi (dakika)")
...
class UserNotification(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='user_notifications', verbose_name="Kullanıcı")
    notification_type = models.CharField(max_length=20, choices=NOTIFICATION_TYPES, default='info', verbose_name="Tip")
    priority = models.CharField(max_length=20, choices=PRIORITY_LEVELS, default='normal', verbose_name="Öncelik")
    
    # İçerik
    title = models.CharField(max_length=200, verbose_name="Başlık")
    message = models.TextField(verbose_name="Mesaj")
    action_url = models.CharField(max_length=500, blank=True, verbose_name="Aksiyon URL")
...
class TwoFactorAuth(models.Model):
    ...
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='two_factor_auth', verbose_name="Kullanıcı")
    is_enabled = models.BooleanField(default=False, verbose_name="Aktif")
    method = models.CharField(max_length=10, choices=METHOD_CHOICES, default='totp', verbose_name="Yöntem")
    ...
    # İstatistikler
    enabled_at = models.DateTimeField(null=True, blank=True, verbose_name="Aktif Edilme")
...
class PasswordHistory(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='password_history', verbose_name="Kullanıcı")
    password_hash = models.CharField(max_length=255, verbose_name="Şifre Hash")
    
    # Değişiklik bilgisi
    changed_by = models.ForeignKey(CustomUser, on_delete=models.SET_NULL, null=True, related_name='password_changes_made', verbose_name="Değiştiren")
    change_reason = models.CharField(max_length=200, blank=True, verbose_name="Değişiklik Sebebi")
...
class UserSession(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='user_sessions', verbose_name="Kullanıcı")
...
class UserPreference(models.Model):
    ...
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='preferences', verbose_name="Kullanıcı")
    ...
    theme = models.CharField(max_length=20, choices=[
        ...
        ('dark', 'Koyu Tema'),
        ('auto', 'Otomatik')
    ], default='light', verbose_name="Tema")
    ...
    require_password_change = models.BooleanField(default=False, verbose_name="Şifre Değişikliği Gerekli")
    password_change_interval = models.IntegerField(default=90, verbose_name="Şifre Değişim Aralığı (gün)")
    
    # Diğer
    default_dashboard = models.CharField(max_length=50, blank=True, verbose_name="Varsayılan Dashboard")
    custom_settings = models.JSONField(default=dict, blank=True, verbose_name="Özel Ayarlar")
