    ...
    def handle(self, *args, **options):
        plans = [
            ...
            dict(
                code="sme_starter",
                name="Başlangıç",
                description="KOBİ - Başlangıç Planı",
                audience="sme",
            ...
            dict(
                code="sme_pro",
                name="Profesyonel",
                description="KOBİ - Pro Plan",
                audience="sme",
                period_options="monthly_yearly",
                monthly_price=799.00,
                yearly_price=799.00 * 12,
                user_limit=5,
                features=[
            ...
            dict(
                code="sme_enterprise",
                name="Kurumsal",
                description="KOBİ - Enterprise Plan",
                audience="sme",
                period_options="yearly",
                monthly_price=1999.00,
                yearly_price=1999.00 * 12,
                user_limit=None,
                features=[
            ...
            dict(
                code="edu_student",
                name="Öğrenci",
                description="Eğitim - Öğrenci Planı",
                audience="edu_student",
                period_options="monthly",
                monthly_price=49.00,
                yearly_price=None,
                user_limit=1,
            ...
            dict(
                code="edu_teacher",
                name="Öğretmen",
                description="Eğitim - Öğretmen Planı",
                audience="edu_teacher",
                period_options="monthly",
            ...
            dict(
                code="edu_campus",
                name="Kampüs/Okul",
                description="Eğitim - Kampüs Planı",
                audience="edu_campus",
                period_options="yearly",
                monthly_price=None,
        ...
        for p in plans:
            ...
            self.stdout.write(
                self.style.SUCCESS(f"{'Created' if created else 'Updated'}: {obj.code}")
            )
