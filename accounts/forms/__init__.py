...
class RegisterForm(UserCreationForm):
    ...
    def clean_email(self):
        ...
        blocked_domains = {
            ...
            'trashmail.com', 'yopmail.com', 'temp-mail.org', 'getnada.com', 'dispostable.com',
        }
        blocked_keywords = (
            'tempmail', 'throwaway', 'mailinator', 'guerrilla', '10minutemail', 'yopmail', 'trashmail', 'temp-mail', 'getnada', 'dispostable'
        )
    ...
    def clean(self):
        ...
        if pw is not None:
            ...
            if not pw_str.strip():
            ...
            elif pw_str.lower() in {'password', 'qwerty', 'letmein', '12345678', '123456789'}:
                self.add_error('password1', 'Şifre çok yaygın, lütfen daha güçlü bir şifre seçin.')
            elif pw_str.isdigit():
                ...
                if not (has_letter and has_digit):
                    self.add_error('password1', 'Şifre en az bir harf ve bir rakam içermelidir.')
...
class OTPVerifyForm(forms.Form):
    token = forms.CharField(
        ...
        max_length=6,
        min_length=4,
        widget=forms.TextInput(attrs={"autocomplete": "one-time-code", "class": "form-control"}),
    )
