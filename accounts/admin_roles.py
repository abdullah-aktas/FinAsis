# accounts/admin.py - Rol sistemi için admin entegrasyonu
...
class UserRoleAdmin(ModelAdmin):
    ...
    def user_count(self, obj):
        ...
        try:
            count = RoleBasedUserProfile.objects.filter(role=obj).count()
            if count > 0:
                url = reverse('admin:accounts_rolebaseduserprofile_changelist')
                return format_html(
    ...
    user_count.short_description = "Kullanıcı Sayısı"  # type: ignore
    ...
    permission_summary.short_description = "İzin Özeti"  # type: ignore
...
class SubscriptionPlanAdmin(ModelAdmin):
    ...
    price_display.short_description = "Fiyat"  # type: ignore
    ...
    def user_count(self, obj):
        ...
        try:
            ...
            return "N/A"
    user_count.short_description = "Aktif Abonə"  # type: ignore
    ...
    feature_summary.short_description = "Özellikler"  # type: ignore
...
class UserSubscriptionAdmin(ModelAdmin):
    ...
    user_link.short_description = "Kullanıcı"  # type: ignore
    ...
    def days_remaining_display(self, obj):
        ...
        if obj.status != 'active':
            ...
            return f"✅ {days} gün"
    days_remaining_display.short_description = "Kalan Süre"  # type: ignore
    ...
    usage_summary.short_description = "Kullanım"  # type: ignore
    ...
    usage_display.short_description = "Kullanım Detayları"  # type: ignore
    ...
    activate_subscription.short_description = "Seçilen abonelikleri aktifleştir"  # type: ignore
    ...
    suspend_subscription.short_description = "Seçilen abonelikleri askıya al"  # type: ignore


@admin.register(RoleBasedUserProfile)
class UserProfileAdmin(ModelAdmin):
    ...
    role_badge.short_description = "Rol"  # type: ignore
    
    def subscription_status(self, obj):
        """Abonelik durumu"""
        try:
            subscription = obj.user.role_subscription
            ...
            return "❓ Abonelik yok"
    subscription_status.short_description = "Abonelik"  # type: ignore
    ...
    last_login_display.short_description = "Son Giriş"  # type: ignore
    ...
    security_status.short_description = "Güvenlik"  # type: ignore
    ...
    enable_2fa.short_description = "2FA'yi aktifleştir"  # type: ignore
    ...
    unlock_users.short_description = "Hesap kilidini aç"  # type: ignore


# User modelini genişlet
class UserProfileInline(admin.StackedInline):
    model = RoleBasedUserProfile
    can_delete = False
...
class UserAdmin(BaseUserAdmin):
    ...
    list_filter = list(BaseUserAdmin.list_filter) + [
        'profile__role', 'subscription__plan', 'subscription__status'
    ]
    ...
    user_role.short_description = "Rol"  # type: ignore
    
    def subscription_plan(self, obj):
        """Abonelik planı"""
        try:
            return obj.role_subscription.plan.display_name
        except:
            return "❓ Abonelik yok"
    subscription_plan.short_description = "Plan"  # type: ignore
