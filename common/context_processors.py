...
def rbac_context(request):
    ...
    return {
        ...
        'is_company_owner': user_role in ['superadmin', 'system_admin', 'company_owner', 'kobi_owner'],
        'has_finance_access': user_role in ['superadmin', 'system_admin', 'company_owner', 'kobi_owner', 'finance_manager', 'accountant', 'kobi_employee'],
...
def user_roles(request):
    ...
    return {
        ...
        'is_finance_manager': user_role in ['superadmin', 'company_owner', 'kobi_owner', 'finance_manager'],
