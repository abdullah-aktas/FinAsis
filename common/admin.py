...
from .models import (
    ...
    SystemSetting, FileUpload, EmailTemplate, EmailLog,
    APIKey, Webhook, WebhookLog, ScheduledTask
)
...
class ApprovalRequestAdmin(admin.ModelAdmin):
    list_display = ('content_type', 'status', 'requested_by', 'decided_by', 'created_at')
...
class SystemSettingAdmin(admin.ModelAdmin):
    list_display = ('key', 'value', 'value_type', 'category', 'is_public', 'is_editable', 'updated_at')
...
class FileUploadAdmin(admin.ModelAdmin):
    list_display = ('original_filename', 'category', 'file_size', 'uploaded_by', 'is_scanned', 'is_safe', 'is_public', 'uploaded_at')
...
class EmailLogAdmin(admin.ModelAdmin):
    list_display = ('to_email', 'subject', 'status', 'template', 'sent_at', 'opened_at', 'created_at')
...
class APIKeyAdmin(admin.ModelAdmin):
    list_display = ('name', 'user', 'key', 'is_active', 'total_requests', 'rate_limit', 'last_used_at', 'expires_at')
...
class WebhookAdmin(admin.ModelAdmin):
    list_display = ('name', 'event_type', 'url', 'is_active', 'user', 'total_calls', 'success_count', 'failure_count', 'last_called_at')
    search_fields = ('name', 'url', 'user__username')
    list_filter = ('event_type', 'is_active', 'created_at')
    readonly_fields = ('total_calls', 'success_count', 'failure_count', 'last_called_at', 'created_at')


@admin.register(WebhookLog)
class WebhookLogAdmin(admin.ModelAdmin):
    list_display = ('webhook', 'is_success', 'response_status', 'response_time_ms', 'retry_count', 'created_at')
...
class ScheduledTaskAdmin(admin.ModelAdmin):
    list_display = ('name', 'task_type', 'status', 'scheduled_at', 'is_recurring', 'created_by', 'started_at', 'completed_at')
