...
class PermissionGroups:
    """İzin grupları"""
    # Finansal işlemler
    CAN_VIEW_FINANCE = ['admin', 'kobi_owner', 'kobi_employee', 'accountant', 'financial_advisor', 'finance_manager']
    CAN_CREATE_INVOICE = ['admin', 'kobi_owner', 'kobi_employee', 'accountant']
    CAN_DELETE_INVOICE = ['admin', 'kobi_owner']
    CAN_APPROVE_PAYMENT = ['admin', 'kobi_owner', 'finance_manager']
    
    # Eğitim işlemleri
    CAN_VIEW_EDUCATION = ['admin', 'teacher', 'student', 'kobi_employee']
    CAN_CREATE_COURSE = ['admin', 'teacher']
    CAN_GRADE_ASSIGNMENT = ['admin', 'teacher']
    
    # Oyun işlemleri
    CAN_PLAY_GAMES = ['admin', 'player', 'student', 'kobi_employee']
    CAN_VIEW_LEADERBOARD = ['admin', 'player', 'student', 'teacher', 'kobi_employee']
    ...
    # AI Asistan
    CAN_USE_AI = ['admin', 'kobi_owner', 'kobi_employee', 'accountant', 'financial_advisor', 'finance_manager', 'teacher']
...
def get_role_display_name(role_code):
    ...
    role_names = {
        ...
        'player': 'Oyuncu',
        'auditor': 'Denetçi',
        'business_owner': 'İşletme Sahibi',  # geriye dönük uyumluluk
        'employee': 'Çalışan',
    }
...
def get_role_icon(role_code):
    ...
    role_icons = {
        ...
        'kobi_employee': 'bi-person-workspace',
        ...
        'business_owner': 'bi-building',  # geriye dönük uyumluluk
