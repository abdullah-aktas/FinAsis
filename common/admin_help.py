...
class SupportTicketAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["user", "ip_address", "user_agent", "created_at", "updated_at"]

    fieldsets = (
        ("Talep Bilgileri", {"fields": ("user", "subject", "message", "priority")}),
        ("Durum", {"fields": ("status", "assigned_to", "resolution", "resolved_at")}),
        (
            "Metadata",
            {
