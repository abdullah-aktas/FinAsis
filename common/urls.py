...
api_urlpatterns = [
    ...
    path(
        ...
        api_role_assignment.role_assignment_summary,
        name="api_role_assignment_summary",
    ),
    path(
        "role-assignment/rules/",
        api_role_assignment.role_assignment_rules,
        name="api_role_assignment_rules",
    ),
    path(
        "role-assignment/assign-all/",
        api_role_assignment.assign_roles_all_users,
        name="api_assign_roles_all_users",
    ),
    path(
        "role-assignment/assign-user/<int:user_id>/",
        api_role_assignment.assign_roles_single_user,
        name="api_assign_roles_single_user",
    ),
    path(
        "role-assignment/assign-user-type/<str:user_type_code>/",
        api_role_assignment.assign_roles_by_user_type,
        name="api_assign_roles_by_user_type",
    ),
    path(
        "role-assignment/create-groups/",
        api_role_assignment.create_required_groups_api,
        name="api_create_required_groups",
    ),
    path(
        "role-assignment/users-without-groups/",
        api_role_assignment.users_without_groups,
        name="api_users_without_groups",
    ),
    path(
        "role-assignment/group-stats/",
        api_role_assignment.group_statistics,
        name="api_group_statistics",
    ),
    path(
        "role-assignment/my-info/",
        api_role_assignment.my_role_info,
        name="api_my_role_info",
    ),
]
...
urlpatterns = [
    ...
    path(
        "approvals/request/<str:app_label>/<str:model>/<int:pk>/",
        views.request_approval,
        name="request_approval",
    ),
    path(
        "approvals/<int:pk>/<str:action>/",
    ...
    path(
        "health/detailed/",
        views_health.health_check_detailed,
