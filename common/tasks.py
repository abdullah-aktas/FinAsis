...
def generate_invoice_pdf(invoice_id):
    ...
    result = generate_pdf_report(report_type='invoice', report_id=invoice_id, user_id=None)
    return result
...
def generate_financial_report_pdf(report_id, user_id):
    ...
    # Call the actual PDF generation task
    result = generate_pdf_report(report_type='financial', report_id=report_id, user_id=user_id)
    return result
