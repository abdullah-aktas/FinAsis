...
class SecurityPolicyAdmin(admin.ModelAdmin):
    list_display = ('name', 'policy_type', 'is_active', 'is_enforced', 'priority', 'created_by', 'created_at')
...
class SecurityIncidentAdmin(admin.ModelAdmin):
    list_display = ('title', 'incident_type', 'severity', 'source_ip', 'affected_user', 'is_resolved', 'detected_at')
    ...
    def mark_as_resolved(self, request, queryset):
        ...
        self.message_user(request, f'{updated} güvenlik olayı çözüldü olarak işaretlendi.')
...
class IPWhitelistAdmin(admin.ModelAdmin):
    list_display = ('ip_address', 'description', 'user', 'is_active', 'usage_count', 'last_used_at', 'valid_until')
...
class IPBlacklistAdmin(admin.ModelAdmin):
    list_display = ('ip_address', 'reason', 'blocked_attempts', 'is_active', 'first_blocked_at', 'auto_unblock_at')
    search_fields = ('ip_address', 'description')
