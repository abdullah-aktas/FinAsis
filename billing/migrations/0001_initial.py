...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.CharField(choices=[('month', 'Aylık'), ('year', 'Yıllık')], default='month', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_customer_id', models.CharField(blank=True, default='', max_length=100)),
                ('external_subscription_id', models.CharField(blank=True, default='', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, max_digits=10)),
                ('currency', models.CharField(default='TRY', max_length=3)),
                ('method', models.CharField(choices=[('paytr', 'PayTR'), ('bank', 'Banka Havale/EFT')], max_length=10)),
